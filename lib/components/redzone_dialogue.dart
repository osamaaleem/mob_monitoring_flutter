...
class RedzoneDialogue extends StatelessWidget {
  const RedzoneDialogue({Key? key}) : super(key: key);
    ...
    return  Dialog(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Text('Do you want to add redzone coordinates?',style: Theme.of(context).textTheme.titleMedium,),
